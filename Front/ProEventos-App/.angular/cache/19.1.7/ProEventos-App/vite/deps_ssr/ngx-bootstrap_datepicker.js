...
var TooltipDirective = class _TooltipDirective {
  ...
  show() {
    ...
    if (this.delay) {
      ...
      this._delaySubscription = (0, import_rxjs3.timer)(this.delay).subscribe(() => {
        showTooltip();
...
var BsDatepickerAbstractComponent = class {
  constructor() {
    ...
    this.customRanges = [];
    this.chosenRange = [];
    this._daysCalendarSub = new import_rxjs4.Subscription();
    this.selectedTimeSub = new import_rxjs4.Subscription();
  }
  set minDate(value) {
...
var BsLocaleService = class _BsLocaleService {
  constructor() {
    ...
    this._locale = new import_rxjs4.BehaviorSubject(this._defaultLocale);
...
var BsDatepickerEffects = class _BsDatepickerEffects {
  ...
  setBindings(container) {
    ...
    container.options$ = (0, import_rxjs4.combineLatest)([this._store.select((state2) => state2.showWeekNumbers), this._store.select((state2) => state2.displayMonths)]).pipe((0, import_operators2.map)((latest) => ({
...
var BsDatepickerStore = class _BsDatepickerStore extends MiniStore {
  constructor() {
    const _dispatcher = new import_rxjs4.BehaviorSubject({
...
var BsDatepickerDirective = class _BsDatepickerDirective {
  ...
  constructor(_config, _elementRef, _renderer, _viewContainerRef, cis) {
    ...
    this.isDestroy$ = new import_rxjs4.Subject();
    this.isDisabled = false;
    this.bsValueChange = new EventEmitter();
    this._subs = [];
    this._dateInputFormat$ = new import_rxjs4.Subject();
    Object.assign(this, this._config);
    this._datepicker = cis.createLoader(_elementRef, _viewContainerRef, _renderer);
    this.onShown = this._datepicker.onShown;
    this.onHidden = this._datepicker.onHidden;
    this.isOpen$ = new import_rxjs4.BehaviorSubject(this.isOpen);
  }
  /**
...
var BsDatepickerInputDirective = class _BsDatepickerInputDirective {
  constructor(_picker, _localeService, _renderer, _elRef, changeDetection) {
    ...
    this._subs = new import_rxjs4.Subscription();
  }
  onChange(event) {
...
var BsDaterangepickerDirective = class _BsDaterangepickerDirective {
  ...
  constructor(_config, _elementRef, _renderer, _viewContainerRef, cis) {
    ...
    this.bsValueChange = new EventEmitter();
    this._subs = [];
    this._rangeInputFormat$ = new import_rxjs4.Subject();
    this._datepicker = cis.createLoader(_elementRef, _viewContainerRef, _renderer);
